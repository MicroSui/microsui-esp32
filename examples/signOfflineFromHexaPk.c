...
// Private key in hexa format, must be 32 bytes long
...
// Generated TX Build Message in HEX with `await tx.build({ client });` in Mysten Typescript SDK
...
void app_main() {
    ...
    printf("\n\n\n\t\t\t --- ESP32 OFFLINE SIGN (with Hexa PK) DEMO ---\n");
